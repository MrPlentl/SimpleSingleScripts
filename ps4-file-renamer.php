<?php
# PS4 File Renamer
# Description: If you want an easy way to rename you PS4 Image and Video files, and also track the ones you already have, this might be for you.
# Requirements: Any valid PHP version installed on you machine
# Installation: Just place inside the PS4 directory on you USB drive after you've copied your files,
#               and then run: php ps4-file-renamer.php from a command line or terminal.
# Results: This files in the Video Clips and Screenshots directory will be renamed.
#          If the file has already been renamed and then copied to the USB drive again, it will be deleted.

const VID_DIR = "./SHARE/Video Clips";  //Video Directory to be scanned
const PIC_DIR = "./SHARE/Screenshots";  //Screenshot Directory to be scanned
